...
angular.module('APIMATICCalculatorLib')
    .factory('MySimpleCalculatorController', ['$q',
        'Configuration',
        'HttpClient',
        'APIHelper',
        'BaseController',
        MySimpleCalculatorController
    ]);

    function MySimpleCalculatorController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
