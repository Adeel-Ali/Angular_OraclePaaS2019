...
angular.module('APIMATICCalculatorLib')
    .factory('Pass2019MallorcaCalculatorController', ['$q',
        'Configuration',
        'HttpClient',
        'APIHelper',
        'BaseController',
        Pass2019MallorcaCalculatorController
    ]);

    function Pass2019MallorcaCalculatorController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
