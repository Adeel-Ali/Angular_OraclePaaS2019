...
angular.module('APIMATICCalculatorLib')
    .factory('OraclePaasMallorcaCalculatorController', ['$q',
        'Configuration',
        'HttpClient',
        'APIHelper',
        'BaseController',
        OraclePaasMallorcaCalculatorController
    ]);

    function OraclePaasMallorcaCalculatorController($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
