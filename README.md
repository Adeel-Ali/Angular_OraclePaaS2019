...
<head>
    ...
    <script src="scripts/APIMATICCalculatorLib/Controllers/Pass2019MallorcaCalculatorController.js"></script>
...
## <a name="pass2019_mallorca_calculator_controller"></a>![Class: ](https://apidocs.io/img/class.png ".Pass2019MallorcaCalculatorController") Pass2019MallorcaCalculatorController

### Get singleton instance

The singleton instance of the ``` Pass2019MallorcaCalculatorController ``` class can be accessed via Dependency Injection.

```js
	app.controller("testController", function($scope, Pass2019MallorcaCalculatorController){
	});
```

### <a name="get_calculate"></a>![Method: ](https://apidocs.io/img/method.png ".Pass2019MallorcaCalculatorController.getCalculate") getCalculate
...
```javascript
	...
	app.controller("testController", function($scope, Pass2019MallorcaCalculatorController){
		...
		var result = Pass2019MallorcaCalculatorController.getCalculate(input);
